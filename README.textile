...
This project inspired and partly derived from Cloudscaling's "swift-solo":http://github.com/cloudscaling/swift-solo.
Also thanks go to "Krzysztof Wilczynski":http://twitter.com/kwilczynski for his help with obscure apt-get/dpkg
options.

h2. Notes

I have installed this inside a Ubuntu 10.04 virtual machine. Most pieces install and run however things are not
working quite right yet ie. you can upload images into a bucket but can't register them. Granted packages that are
used are a bit old (early July). I will be trying newer packages shortly. This is work in progress.
